            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                 ...
                 <li class="sub-menu">
                    <a href="javascript:;">
                        <i class="fa fa-book"></i>
                        <span>NEN/FIG theo Anime/Phim/Nhóm</span>
                    </a>
                    <ul class="sub">
						<li><a href="{{URL::to('/add-brand-product')}}">Thêm NEN/FIG theo Anime/Phim/Nhóm</a></li>
						<li><a href="{{URL::to('/all-brand-product')}}">Liệt kê NEN/FIG theo Anime/Phim/Nhóm</a></li>
