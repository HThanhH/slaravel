            ...
            <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                           Thêm NEN/FIG theo Anime/Phim/Nhóm
                        </header>
                         <?php
                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Tên NEN/FIG theo Anime/Phim/Nhóm</label>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Mô tả NEN/FIG theo Anime/Phim/Nhóm</label>
